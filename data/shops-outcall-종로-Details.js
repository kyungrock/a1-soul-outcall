  ...
  "shops": [
    {
      ...
      "detailAddress": "서울 시내 어디든 방문 가능합니다. 지하철역 출구·건물 로비·주차장 중 만나기 편한 곳을 정해 주시면 이동 동선을 줄입니다. 야간·새벽은 수신 상태에 따라 달라질 수 있습니다.",
      ...
      "description": "서울 전역을 오가며 하루를 보낸 분들을 위한 방문형 케어입니다. 장시간 걸음 뒤에는 종아리·발목부터, 책상·노트북 위주였다면 견갑·목 라인을 먼저 짚습니다. 실내 환기가 잘되면 오일 단계를 길게, 답답하면 건식 비중을 올려 드립니다.",
      "services": [
        "출장마사지",
        "스포츠 마사지",
        "오일 마사지",
      ...
      "courses": [
        {
          "category": "서울 출장 · 꾹꾹 시원 스포츠",
          "items": [
            {
              "name": "A코스",
              "price": "70,000원",
              "duration": "60분",
              "description": "꾹꾹 시원 스포츠 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "90,000원",
        ...
        {
          "category": "서울 출장 · 감미로운 오일마사지",
          "items": [
            {
              "name": "A코스",
              "price": "80,000원",
              "duration": "60분",
              "description": "감미로운 오일마사지 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "100,000원",
        ...
        {
          "category": "서울 출장 · 감성힐링 스웨디시",
          "items": [
            {
              "name": "A코스",
              "price": "90,000원",
              "duration": "60분",
              "description": "감성힐링 스웨디시 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "110,000원",
        ...
        {
          "category": "서울 출장 · VVIP 특급마사지",
          "items": [
            {
              "name": "A코스",
              "price": "120,000원",
              "duration": "60분",
              "description": "VVIP 특급마사지 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "140,000원",
        ...
        {
          "category": "서울 출장 · 믹스 코스",
          "items": [
            {
              "name": "A코스",
              "price": "130,000원",
              "duration": "120분",
              "description": "60분 꾹꾹 + 60분 힐링 (실장님 강력추천) · 서울 일대 방문형"
            },
            {
              "name": "A코스",
              "price": "160,000원",
              "duration": "150분",
              "description": "60분 꾹꾹 + 60분 VVIP · 서울 일대 방문형"
            }
          ]
        },
        {
          "category": "서울 출장 · 한국인 스웨디시",
          "items": [
            {
              "name": "a노말",
              "price": "140,000원",
              "duration": "60분",
              "description": "한국인 스웨디시 · 서울 일대 방문형"
            },
            {
              "name": "a노말",
              "price": "180,000원",
            ...
            },
            {
              ...
              "price": "160,000원",
              "duration": "60분",
              "description": "한국인 스웨디시 VVIP · 서울 일대 방문형"
            },
            {
              "name": "aVVIP",
              "price": "200,000원",
      ...
      "reviews": [
        {
          ...
          "rating": 5,
          "date": "2026-05-21",
          "reviewBody": "퇴근하고 숙소 들어와 서울 출장 불렀어요. 발목까지 무거운 줄 몰랐는데 아래부터 풀어 주니 어깨도 따라 가벼워졌습니다. 만남 지점만 문자로 정했더니 수월했어요."
        },
        {
          "author": "재택근무님",
          "rating": 5,
          "date": "2026-05-22",
          "reviewBody": "모니터만 본 날이라 승모만 부탁했더니 그 라인만 길게 잡아 주셨습니다. 서울 전역이라 다음에도 같은 방식으로 부를 것 같아요."
        }
      ],
      "features": [
        "서울 전역 홈타이·호텔·오피스",
      ...
      "greeting": "안녕하세요. 오늘은 ‘많이 걸었다’와 ‘많이 앉았다’ 중 어느 쪽에 가까우셨는지 한마디만 알려 주세요. 서울 전역 라인은 그에 맞춰 첫 손을 놓는 위치부터 정합니다."
    },
    {
      ...
      "detailAddress": "동·호·엘리베이터 번호를 알려 주시면 로비에서 만남까지 빨라집니다. 좁은 원룸도 가능한 자세만 미리 말씀해 주세요.",
      ...
      "description": "서울 어디서든 한국 20대 라인으로 말이 통하는 상담을 드립니다. 첫 이용이어도 통화에서 코스명과 소요만 정하면 순서가 헷갈리지 않습니다. 장시간 이동 뒤엔 하체, 회의만 있었다면 상체 비중을 올립니다.",
      "services": [
        "출장마사지",
        "스포츠 마사지",
        "오일 마사지",
    ...
    },
    {
      ...
      "detailAddress": "새벽·심야는 문자로 주소·만남 위치를 남겨 주시면 연결 속도가 빨라집니다. 숙박 시설은 건물명과 지도 핀을 함께 보내 주세요.",
      "phone": "0507-1859-6753",
      "price": "70,000원~",
      ...
      "description": "서울 전역에서 한국식 직선 압과 일본식 리듬을 섞는 혼혈 라인입니다. 처음엔 호흡에 맞춰 천천히 올리고, 야근 직후엔 목·등을 먼저 짚는 편이 많습니다.",
      "services": [
        "출장마사지",
        "스포츠 마사지",
        "오일 마사지",
    ...
    },
    {
      ...
      "detailAddress": "게이트·로비 통과 방식이 건물마다 다릅니다. 경비실 이름·QR 필요 여부를 통화 때 함께 남겨 주세요. 실내가 건조하면 오일 농도부터 맞춥니다.",
      ...
      "description": "서울 전역 고층·단지에서도 말이 통하는 한국인 VIP 라인으로 진행합니다. 시간을 넉넉히 쓸수록 어깨·등 라인이 차분히 내려가고, 조명·냉방 선호만 정해 두시면 흐름이 끊기지 않습니다.",
      "services": [
        "출장마사지",
        "VIP 스웨디시"
      ],
      "courses": [
        {
          "category": "서울 출장 · VIP 스웨디시",
          "items": [
            {
              "name": "A코스",
              "price": "130,000원",
              "duration": "60분",
              "description": "VIP 스웨디시 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "170,000원",
    ...
    },
    {
      ...
      "detailAddress": "테마 코스는 통화에서 단계와 소요를 먼저 확정합니다. 붐비는 시간대엔 역 출구 기준 만남을 권합니다.",
      ...
      "description": "서울 전역에서 건식으로 긴장을 낮춘 뒤 이완으로 넘어가는 흐름을 기본으로 합니다. 낮과 밤 이동 패턴이 다를 때는 만남 위치 하나만 정해 두면 지연이 줄어듭니다.",
      "services": [
        "출장마사지",
        "건식테라피",
        "센슈얼스웨디시",
      ...
      "courses": [
        {
          "category": "서울 출장 · T팬티 예선전 - 건식테라피",
          "items": [
            {
              "name": "A코스",
              "price": "60,000원",
              "duration": "60분",
              "description": "건식테라피 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "80,000원",
        ...
        {
          "category": "서울 출장 · T팬티 본선전 - 센슈얼스웨디시",
          "items": [
            {
              "name": "A코스",
              "price": "80,000원",
              "duration": "60분",
              "description": "센슈얼스웨디시 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "100,000원",
    ...
    },
    {
      ...
      "description": "서울 전역에서 산책·이동 뒤 종아리가 먼저 말하는 경우가 많습니다. 호흡에 맞춰 박자를 나누고, 킥보드·자전거 이동 날에는 허벅지 앞쪽을 짧게 여러 번 풀어 드립니다.",
      "services": [
        "출장마사지",
        "스포츠 마사지",
        "오일 마사지",
    ...
    },
    {
      ...
      "description": "서울 전역 야간 동선은 어깨가 먼저 뭉치거나, 술자리 전엔 목·등이 예민해지는 경우가 많습니다. 한·일 혼합 라인이라 설명을 짧게 해도 따라오기 쉬운 편입니다.",
      "services": [
        "출장마사지",
        "힘 쿵",
        "심 쿵",
      ...
      "courses": [
        ...
        {
          "category": "서울 출장 · 짜릿 스웨디시",
          "items": [
            {
              "name": "A코스",
              "price": "80,000원",
              "duration": "60분",
              "description": "짜릿 스웨디시 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "100,000원",
        ...
        {
          "category": "서울 출장 · 도쿄핫VIP 힐링힙업",
          "items": [
            {
              "name": "A코스",
              "price": "90,000원",
              "duration": "60분",
              "description": "도쿄핫VIP 힐링힙업 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "110,000원",
        ...
        {
          "category": "서울 출장 · 도쿄핫VVIP 극찬코스",
          "items": [
            {
              "name": "A코스",
              "price": "110,000원",
              "duration": "60분",
              "description": "도쿄핫VVIP 극찬코스 (넘사벽 스케일) · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "130,000원",
        ...
        {
          "category": "서울 출장 · 이쁜 한국인",
          "items": [
            {
              "name": "일반 코스",
              "price": "130,000원",
              "duration": "60분",
              "description": "이쁜 한국인 (20대~30대 초반) · 서울 일대 방문형"
            },
            {
              "name": "일반 코스",
              "price": "170,000원",
    ...
    },
    {
      ...
      "description": "서울 전역에서 통로를 오래 걷거나 키보드만 본 날이 겹치기 쉽습니다. 시간이 짧으면 목·승모만, 여유가 있으면 손목·전완까지 이어 붙입니다.",
      "services": [
        "출장마사지",
        "건강 케어",
        "끈적 오일",
      ...
      "courses": [
        {
          "category": "서울 출장 · 건강 케어",
          "items": [
            {
              "name": "A코스",
              "price": "60,000원",
              "duration": "60분",
              "description": "건강 케어 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "80,000원",
        ...
        {
          "category": "서울 출장 · 끈적 오일",
          "items": [
            {
              "name": "A코스",
              "price": "70,000원",
              "duration": "60분",
              "description": "끈적 오일 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "90,000원",
        ...
        {
          "category": "서울 출장 · 끈적 힙업힐링",
          "items": [
            {
              "name": "A코스",
              "price": "80,000원",
              "duration": "60분",
              "description": "끈적 힙업힐링 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "100,000원",
        ...
        {
          "category": "서울 출장 · 원정녀 황제 VIP",
          "items": [
            {
              "name": "A코스",
              "price": "90,000원",
              "duration": "60분",
              "description": "원정녀 황제 VIP · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "110,000원",
        ...
        {
          "category": "서울 출장 · VVIP 원정 풀",
          "items": [
            {
              "name": "A코스",
              "price": "110,000원",
              "duration": "60분",
              "description": "VVIP 원정 풀 (실장 추천) · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "130,000원",
        ...
        {
          "category": "서울 출장 · 레전드 한국인",
          "items": [
            {
              "name": "VIP코스",
              "price": "130,000원",
              "duration": "60분",
              "description": "레전드 한국인 (20대~30대 초반) · 서울 일대 방문형"
            },
            {
              "name": "VIP코스",
              "price": "170,000원",
    ...
    },
    {
      ...
      "description": "서울 전역에서 낮엔 상가 통로를 오래 걷고 밤엔 자세가 바뀌는 패턴이 많습니다. 타이처럼 넓게 풀기와 스웨처럼 천천히 이어 붙이기 사이에서 몸 느낌만 말해 주시면 첫 손 위치가 달라집니다.",
      "services": [
        "출장마사지",
        "타이 코스",
        "미끌 아로밍",
      ...
      "courses": [
        {
          "category": "서울 출장 · 타이 코스",
          "items": [
            {
              "name": "A코스",
              "price": "50,000원",
              "duration": "40분",
              "description": "타이 코스 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "60,000원",
        ...
        {
          "category": "서울 출장 · 미끌 아로밍",
          "items": [
            {
              "name": "A코스",
              "price": "70,000원",
              "duration": "60분",
              "description": "미끌 아로밍 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "90,000원",
        ...
        {
          "category": "서울 출장 · 힐링 & 스웨디시",
          "items": [
            {
              "name": "A코스",
              "price": "80,000원",
              "duration": "60분",
              "description": "힐링 & 스웨디시 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "110,000원",
        ...
        {
          "category": "서울 출장 · VVIP 실장 추천코스",
          "items": [
            {
              "name": "A코스",
              "price": "100,000원",
              "duration": "60분",
              "description": "VVIP 실장 추천코스 힐링 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "130,000원",
            ...
            },
            {
              ...
              "price": "160,000원",
              "duration": "120분",
              "description": "VVIP 실장 추천코스 힐링 & 스웨디시 · 서울 일대 방문형"
            },
            {
              "name": "D코스",
              "price": "190,000원",
        ...
        {
          "category": "서울 출장 · 스페셜 코스",
          "items": [
            {
              "name": "A코스",
              "price": "130,000원",
              "duration": "120분",
              "description": "타이 + 아로마 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "160,000원",
    ...
    },
    {
      ...
      "description": "서울 전역에서 낮엔 산책·행사를 돌고 밤엔 숙소로 바로 들어가는 패턴이 많습니다. ‘목이 더 급하다’처럼 한 줄만 덧붙이면 스포츠 압과 오일 순서를 바꿔 드립니다.",
      "services": [
        "출장마사지",
        "스포츠 마사지",
        "오일 마사지",
          ...
          "items": [
            {
              ...
              "price": "130,000원",
              "duration": "120분",
              "description": "60분 꾹꾹 + 60분 힐링 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "160,000원",
          ...
          "items": [
            {
              ...
              "price": "140,000원",
              "duration": "60분",
              "description": "한국인 스웨디시 a노말 · 서울 일대 방문형"
            },
            {
              "name": "a노말 090분",
              "price": "180,000원",
            ...
            },
            {
              ...
              "price": "160,000원",
              "duration": "60분",
              "description": "한국인 스웨디시 aVVIP · 서울 일대 방문형"
            },
            {
              "name": "aVVIP 090분",
              "price": "200,000원",
    ...
    },
    {
      ...
      "description": "서울 전역 산책 뒤엔 종아리·발바닥이 먼저 말을 합니다. 타이 비중을 올릴지 아로마 비중을 올릴지 당일 컨디션에 맞춰 조절합니다.",
      "services": [
        "출장마사지"
      ],
      "courses": [
        {
          "category": "서울 출장 · 힘빼 타이",
          "items": [
            {
              "name": "A코스",
              "price": "70,000원",
              "duration": "60분",
              "description": "힘빼 타이 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "90,000원",
        ...
        {
          "category": "서울 출장 · 느낌 아로마",
          "items": [
            {
              "name": "A코스",
              "price": "70,000원",
              "duration": "60분",
              "description": "느낌 아로마 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "90,000원",
        ...
        {
          "category": "서울 출장 · 비키니 VIP 힐링",
          "items": [
            {
              "name": "A코스",
              "price": "90,000원",
              "duration": "60분",
              "description": "비키니 VIP 힐링 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "110,000원",
        ...
        {
          "category": "서울 출장 · 비키니 VVIP힐링",
          "items": [
            {
              "name": "A코스",
              "price": "110,000원",
              "duration": "60분",
              "description": "비키니 VVIP힐링 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "130,000원",
    ...
    },
    {
      ...
      "description": "서울 전역 고층에서 회의와 이동이 겹쳐 목만 남고 몸은 괜찮다거나 허리만 묵직하다처럼 부위가 쏠립니다. 스웨디시 한 코스 안에서도 위·아래 시간 배분을 조금씩 바꿔 드립니다.",
      "services": [
        "출장마사지"
      ],
      "courses": [
    ...
    },
    {
      ...
      "description": "서울 전역 야간에는 어깨가 먼저 뭉치거나, 술자리 전엔 목·등이 예민해지는 경우가 많습니다. 한국 라인은 넓게 풀기, 일본 라인은 리듬을 짧게 끊듯 이완하는 식으로 손맛이 달라집니다.",
      "services": [
        "출장마사지"
      ],
      "courses": [
        ...
        {
          "category": "서울 출장 · 일본인 스웨디시",
          "items": [
            {
              "name": "A코스",
              "price": "180,000원",
              "duration": "60분",
              "description": "일본인 스웨디시 · 서울 일대 방문형"
            }
          ]
        }
      ],
    ...
    },
    {
      ...
      "description": "서울 전역 호텔·오피스는 새벽 출장과 늦은 회식이 겹칩니다. 짧은 시간이면 스포츠로 뭉침만 빼고, 숙소에서 길게 쉴 계획이면 스웨 쪽으로 이어 붙이는 식으로 목표만 바꿔 맞춥니다.",
      "services": [
        "출장마사지"
      ],
      "courses": [
    ...
    },
    {
      ...
      "description": "서울 전역에서 걷다 보면 종아리가, 장시간 앉으면 견갑이 먼저 굳습니다. 한국 라인은 압을 조금 더 직선적으로, 타이 라인은 리듬을 길게 이어 붙입니다.",
      "services": [
        "출장마사지"
      ],
      "courses": [
        {
          "category": "서울 출장 · BJ 시원한 건식테라피",
          "items": [
            {
              "name": "A코스",
              "price": "60,000원",
              "duration": "60분",
              "description": "BJ 시원한 건식테라피 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "80,000원",
        ...
        {
          "category": "서울 출장 · BJ성난 \"화끈한\" Y존 스웨디시",
          "items": [
            {
              "name": "A코스",
              "price": "80,000원",
              "duration": "60분",
              "description": "BJ성난 \"화끈한\" Y존 스웨디시 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "100,000원",
        ...
        {
          "category": "서울 출장 · BJ 성난 새끼년 자극적인 전신혼합 VVIP",
          "items": [
            {
              "name": "A코스",
              "price": "100,000원",
              "duration": "60분",
              "description": "BJ 성난 새끼년 자극적인 전신혼합 VVIP · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "120,000원",
        ...
        {
          "category": "서울 출장 · BJ 성난 \"핫\"언니 센슈얼 스웨디시",
          "items": [
            {
              "name": "A코스",
              "price": "140,000원",
              "duration": "60분",
              "description": "BJ 성난 \"핫\"언니 센슈얼 스웨디시 (한국인) · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "180,000원",
    ...
    },
    {
      ...
      "description": "서울 전역 주거가에서 경사와 좁은 골목이 섞인 날과 오래 앉은 날의 피로가 다릅니다. 건식으로 호흡을 넓히는 쪽이 익숙하면 길게, 향·오일이 부담스러우면 스웨 시간만 줄여 드립니다.",
      "services": [
        "출장마사지"
      ],
      "courses": [
        {
          "category": "서울 출장 · 란제리 꾸욱 건식테라피",
          "items": [
            {
              "name": "A코스",
              "price": "60,000원",
              "duration": "60분",
              "description": "란제리 꾸욱 건식테라피 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "80,000원",
        ...
        {
          "category": "서울 출장 · 란제리 \"핫한\" 센슈얼스웨디시",
          "items": [
            {
              "name": "A코스",
              "price": "80,000원",
              "duration": "60분",
              "description": "란제리 \"핫한\" 센슈얼스웨디시 · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "100,000원",
        ...
        {
          "category": "서울 출장 · 란제리 특별한 구멍 전신혼합 VVIP",
          "items": [
            {
              "name": "A코스",
              "price": "100,000원",
              "duration": "60분",
              "description": "란제리 특별한 구멍 전신혼합 VVIP · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "120,000원",
        ...
        {
          "category": "서울 출장 · 란제리 구멍언니 센슈얼 스웨디시",
          "items": [
            {
              "name": "A코스",
              "price": "140,000원",
              "duration": "60분",
              "description": "란제리 구멍언니 센슈얼 스웨디시 (한국인) · 서울 일대 방문형"
            },
            {
              "name": "B코스",
              "price": "180,000원",
